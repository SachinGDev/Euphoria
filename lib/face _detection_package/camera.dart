...
class _CameraViewState extends State<CameraView> {
  ...
  _currentZoomLevel = await _controller?.getMinZoomLevel() ?? 0.0;
  _minAvailableZoom = _currentZoomLevel;
  _maxAvailableZoom = await _controller?.getMaxZoomLevel() ?? 0.0;
  _currentExposureOffset = 0.0;
